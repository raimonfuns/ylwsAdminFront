var App = function () {
	...
	var handleBackstretch = function () {
		 $.backstretch([
		"/static/lib/img/login/1.jpg"
		, "/static/lib/img/login/2.jpg"
		, "/static/lib/img/login/3.jpg"
		, "/static/lib/img/login/4.jpg"
	...
	var handleChat = function (elem) {
		var append = function() {
			...
			var msg = '';
				...
				msg +=	'<img class="media-object" alt="Generic placeholder image" src="/static/lib/img/chat/headshot2.jpg">';
				msg +=  '</a>';
