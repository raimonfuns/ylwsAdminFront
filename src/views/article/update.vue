      ...
      <div class="row">
        <div id="content" class="col-lg-12">
          ...
          <div class="row con-bg-1 content-row">
            <div class="col-md-12">
              <form id="add-article-form" method="post" class="form-horizontal" v-on:submit.prevent>
                <div class="form-group">
                  <div class="col-sm-1 control-label">*标题</div>
                  <div class="col-sm-10">
                    <input name="title" class="form-control" v-model="article.title">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-sm-1 control-label">*URL</div>
                  <div class="col-sm-10">
                    <input type="url" name="url" placeholder="http://" class="form-control" v-model="article.url">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea name="intro" rows="3" class="form-control" v-model="article.intro"></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-sm-1 control-label">文章状态</div>
                  <div class="col-sm-10">
                    <select name="status" class="form-control" v-model="article.status">
                ...
                <div class="form-group">
                  <div class="col-sm-offset-1 col-sm-10">
                    <button id="add-article-btn" type="submit" class="btn btn-primary" @click="updateArticle(article)">保存</button>
                  </div>
                </div>
...
<script>
import { getArticle, updateArticle } from '../../vuex/actions'
export default {
  vuex:{
    getters:{
  ...
  watch: {
    'articleDetail' (obj) {
      this.article = Object.assign({}, obj)
    }
  }
}
</script>